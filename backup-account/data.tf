...
data "aws_iam_policy_document" "kms_policy" {
  ...
  statement {
    sid = "Allow access to backup service"
    ...
    principals {
      ...
      identifiers = [
        ...
        "arn:aws:iam::${var.resource_account}:role/aws-service-role/backup.amazonaws.com/AWSServiceRoleForBackup"
      ]
    }
    principals {
      type        = "Service"
...
data "aws_iam_policy_document" "vault_policy" {
  statement {
    ...
    principals {
      type        = "AWS"
      identifiers = ["arn:aws:iam::${var.resource_account}:root"]
    }
